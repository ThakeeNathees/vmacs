...
// Edit-Start (by @thakeenathees): They should have this by default.
RLAPI static inline void DrawRenderTexture(RenderTexture2D target, Vector2 position) {
  // NOTE: Render texture must be y-flipped due to default OpenGL coordinates (left-bottom)
  DrawTextureRec(
    target.texture,
    CLITERAL(Rectangle){ 0, 0, (float)target.texture.width, (float)-target.texture.height },
    position,
    WHITE);
}
// Edit-End -------------------------------------------------------------------
